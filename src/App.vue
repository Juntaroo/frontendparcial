...
//Porque estas haciendo referencia a esa variable asignandole el valor false
// Parcial: Como accedo al valor de ref para manipular los cambios en la barra lateral? 
//Al agregarle el .value, estamos obteniendo el valor establecido
